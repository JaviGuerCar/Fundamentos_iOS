...
extension LocalFactory: SeasonFactory{
    ...
    var seasons: [Season] {
        get {
            ...
            // Creo las Seasons
            let season1 = Season(name: "Season 1", releaseDate: dateS1Ep1!)
            let season2 = Season(name: "Season 2", releaseDate: dateS2Ep1!)
            let season3 = Season(name: "Season 3", releaseDate: dateS3Ep1!)
            let season4 = Season(name: "Season 4", releaseDate: dateS4Ep1!)
            let season5 = Season(name: "Season 5", releaseDate: dateS5Ep1!)
            let season6 = Season(name: "Season 6", releaseDate: dateS6Ep1!)
            
            // Creo los Episodes (2 por Season)
            let ep1s1 = Episode(title: "1. Winter Is Coming", issueDate: dateS1Ep1!, season: season1)
            let ep2s1 = Episode(title: "2. The Kingsroad", issueDate: dateS1Ep2!, season: season1)
            
            let ep1s2 = Episode(title: "1. The North Remembers", issueDate: dateS2Ep1!, season: season2)
            let ep2s2 = Episode(title: "2. The Night Lands", issueDate: dateS2Ep2!, season: season2)
            
            let ep1s3 = Episode(title: "1. Valar Dohaeris", issueDate: dateS3Ep1!, season: season3)
            let ep2s3 = Episode(title: "2. Dark Wings, Dark Words", issueDate: dateS3Ep2!, season: season3)
            
            let ep1s4 = Episode(title: "1. Two Swords", issueDate: dateS4Ep1!, season: season4)
            let ep2s4 = Episode(title: "2. The Lion and the Rose", issueDate: dateS4Ep2!, season: season4)
            
            let ep1s5 = Episode(title: "1. The Wars to Come", issueDate: dateS5Ep1!, season: season5)
            let ep2s5 = Episode(title: "2. The House of Black and White", issueDate: dateS5Ep2!, season: season5)
            
            let ep1s6 = Episode(title: "1. The Red Woman", issueDate: dateS6Ep1!, season: season6)
            let ep2s6 = Episode(title: "2. Home", issueDate: dateS6Ep2!, season: season6)
